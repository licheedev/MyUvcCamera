...
public class MainActivity extends BaseActivity implements CameraDialog.CameraDialogParent {
    ...
    private void resultSecondCamera() {
        ...
        mUVCCameraViewSecond.setAspectRatio(
            UVCCamera.DEFAULT_PREVIEW_WIDTH / (float) UVCCamera.DEFAULT_PREVIEW_HEIGHT);
    ...
    protected void onStart() {
        ...
        if (mUVCCameraViewSecond != null) mUVCCameraViewSecond.onResume();
    ...
    protected void onStop() {
        ...
        if (mUVCCameraViewSecond != null) mUVCCameraViewSecond.onPause();
        mCaptureButtonSecond.setVisibility(View.INVISIBLE);
                        ...
                        if (mHandlerSecond.isOpened()) {
                            if (checkPermissionWriteExternalStorage() && checkPermissionAudio()) {
                                if (!mHandlerSecond.isRecording()) {
                                    ...
                                    mCaptureButtonSecond.setColorFilter(
                                        0);    // return to default color
    ...
    private void setCameraButton() {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if ((mHandlerSecond != null) && !mHandlerSecond.isOpened() && (mCaptureButtonSecond
                    != null)) {
                    mCaptureButtonSecond.setVisibility(View.INVISIBLE);
                }
            }
